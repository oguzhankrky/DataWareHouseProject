...
class SelectionScreenActivity : AppCompatActivity() {
    ...
    private fun Service()
    {
        ...
        val myPost = Post(SpinnerObjects.school,SpinnerObjects.sex,SpinnerObjects.Dalc.toInt(),SpinnerObjects.Fedu.toInt(), SpinnerObjects.Fjob, 11,11,11,SpinnerObjects.Medu.toInt(),SpinnerObjects.Mjob,SpinnerObjects.Pstatus,SpinnerObjects.Walc.toInt(),4,SpinnerObjects.activities,"R",17,0,4,"GT3","yes",5,2,"father",1,"yes","yes","yes","yes","course","no","no",2,2)
        //val myPost = Post(SpinnerObjects.school,SpinnerObjects.sex,SpinnerObjects.Dalc.toInt(),SpinnerObjects.Fedu.toInt(), SpinnerObjects.Fjob, 11,11,11,SpinnerObjects.Medu.toInt(),SpinnerObjects.Mjob,SpinnerObjects.Pstatus,SpinnerObjects.Walc.toInt(),SpinnerObjects.absences.toInt(),SpinnerObjects.activities,SpinnerObjects.address,SpinnerObjects.age.toInt(),SpinnerObjects.failures.toInt(),SpinnerObjects.famrel.toInt(),SpinnerObjects.famsize,SpinnerObjects.famsup,SpinnerObjects.freetime.toInt(),SpinnerObjects.goout.toInt(),SpinnerObjects.guardian,SpinnerObjects.health.toInt(),SpinnerObjects.higher,SpinnerObjects.internet,"yes",SpinnerObjects.paid,SpinnerObjects.reason,SpinnerObjects.romantic,SpinnerObjects.schoolsup,SpinnerObjects.studytime.toInt(),SpinnerObjects.traveltime.toInt())
